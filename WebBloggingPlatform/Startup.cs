...
namespace WebBloggingPlatform
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IWebBlogRepository, WebBlogRepository>();
            services.AddScoped<ISendHttpRequest, SendHttpRequest>();
            services.AddAutoMapper(typeof(WebMapping));
